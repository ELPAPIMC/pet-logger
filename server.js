...
// **CAMBIO 1: Definición del nuevo umbral mínimo (opcional, pero buena práctica)**
...
    // **CAMBIO 2: Validar que el valor sea mayor o igual a 1M**
    if (animalData.value < MIN_VALUE_THRESHOLD) { // Antes era 3000000
...
  try {
    // **CAMBIO 3: Valor por defecto de minValue cambiado a 1M**
    const minValue = parseInt(req.query.minValue) || MIN_VALUE_THRESHOLD; // Antes era 3000000
